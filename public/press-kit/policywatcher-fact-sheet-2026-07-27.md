...
Release: 3.9.0-beta.10 Source Continuity Ledger
Release date: 28 July 2026
Canonical site: https://policywatcher.online
Repository: https://github.com/sev7enITA/policywatcher
License: CC BY 4.0
Press contact: info@policywatcher.online

## In one sentence

PolicyWatcher is a public-interest policy evidence project that monitors a configured inventory of public policy sources and makes source status, observed changes, analytical limitations and review boundaries visible.
...
- Web release: 3.9.0-beta.10, dated 28 July 2026.
...
- Source Continuity Ledger: the public Timeline separates evidence-gated provider policy changes from sanitized retrieval and publication-state transitions. It excludes policy text, hashes, diffs, AI analysis, raw failure reasons, final URLs and administrative logs.
- Browser extension: separately versioned at 3.8.3 Beta 3; published on the Chrome Web Store, with no verified official Edge Add-ons listing yet and Safari not yet available.
- Repository: public and reusable under CC BY 4.0. No OSI certification is claimed.

## Current editorial context

European Commission guidance published on 20 July and updated on 24 July 2026 concerns transparency obligations under Article 50 of the EU AI Act that apply from 2 August 2026. This is regulatory context, not proof that PolicyWatcher or any monitored provider is compliant.

Primary source: https://digital-strategy.ec.europa.eu/en/news/commission-publishes-guidelines-transparency-obligations-providers-deployers-certain-ai-systems
