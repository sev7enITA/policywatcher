...
const mediaMetadata = {
  ...
  'policywatcher-release-evidence-pulse-background-2026-08-15.png': { date: '2026-08-15', title: { en: 'Release Evidence Pulse editorial background', it: 'Sfondo editoriale Release Evidence Pulse' }, description: { en: 'Text-free abstract evidence-seismograph background generated with OpenAI image generation under PolicyWatcher art direction. It is not a factual chart.', it: 'Sfondo astratto senza testo ispirato a un sismografo delle evidenze, generato con OpenAI image generation sotto la direzione artistica PolicyWatcher. Non e un grafico fattuale.' }, alt: { en: 'Abstract paper grid with restrained teal, indigo and amber evidence traces', it: 'Griglia astratta su carta con tracce contenute teal, indaco e ambra' }, usage: { en: 'Decorative source layer only. Do not publish as data or omit the AI-generation disclosure when used independently.', it: 'Solo livello sorgente decorativo. Non pubblicare come dato e non omettere la dichiarazione di generazione AI se usato separatamente.' }, creator: 'PolicyWatcher / OpenAI image generation', credit: 'PolicyWatcher art direction / OpenAI image generation' },
  'policywatcher-release-evidence-pulse-en-2026-08-15.png': { date: '2026-08-15', title: { en: 'Release Evidence Pulse infographic in English', it: 'Infografica Release Evidence Pulse in inglese' }, description: { en: 'Deterministically typeset infographic covering six release clusters from 2 through 15 August 2026, with implementation impacts, metrics and explicit residual boundaries. The decorative background is AI-generated and disclosed.', it: 'Infografica composta deterministicamente su sei cluster di release dal 2 al 15 agosto 2026, con impatti implementativi, metriche e limiti residui espliciti. Lo sfondo decorativo e generato con AI e dichiarato.' }, alt: { en: 'Six PolicyWatcher release cards with dates, implementation impacts, metrics and limitations for a fourteen-day evidence window', it: 'Sei schede release PolicyWatcher con date, impatti implementativi, metriche e limiti per una finestra di quattordici giorni' }, usage: { en: 'Implementation inventory, not measured adoption, independent validation or compliance certification. Cite the dated evidence ledger.', it: 'Inventario implementativo, non adozione misurata, validazione indipendente o certificazione di conformita. Citare il ledger delle evidenze datato.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-release-evidence-pulse-it-2026-08-15.png': { date: '2026-08-15', title: { en: 'Release Evidence Pulse infographic in Italian', it: 'Infografica Release Evidence Pulse in italiano' }, description: { en: 'Italian deterministic infographic covering six release clusters from 2 through 15 August 2026, with implementation impacts, metrics and explicit residual boundaries. The decorative background is AI-generated and disclosed.', it: 'Infografica italiana composta deterministicamente su sei cluster di release dal 2 al 15 agosto 2026, con impatti implementativi, metriche e limiti residui espliciti. Lo sfondo decorativo e generato con AI e dichiarato.' }, alt: { en: 'Italian PolicyWatcher infographic with six release cards, impacts, metrics and limitations', it: 'Infografica PolicyWatcher in italiano con sei schede release, impatti, metriche e limiti' }, usage: { en: 'Implementation inventory, not measured adoption, independent validation or compliance certification. Cite the dated evidence ledger.', it: 'Inventario implementativo, non adozione misurata, validazione indipendente o certificazione di conformita. Citare il ledger delle evidenze datato.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-release-evidence-pulse-en-2026-08-15.webp': { date: '2026-08-15', title: { en: 'Release Evidence Pulse web infographic in English', it: 'Infografica web Release Evidence Pulse in inglese' }, description: { en: 'Web-optimized version of the dated English Release Evidence Pulse infographic.', it: 'Versione ottimizzata per il web dell infografica Release Evidence Pulse datata in inglese.' }, alt: { en: 'Six PolicyWatcher release cards in an English fourteen-day evidence infographic', it: 'Sei schede release PolicyWatcher in un infografica inglese sulle evidenze di quattordici giorni' }, usage: { en: 'Implementation inventory, not measured adoption, independent validation or compliance certification.', it: 'Inventario implementativo, non adozione misurata, validazione indipendente o certificazione di conformita.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-release-evidence-pulse-it-2026-08-15.webp': { date: '2026-08-15', title: { en: 'Release Evidence Pulse web infographic in Italian', it: 'Infografica web Release Evidence Pulse in italiano' }, description: { en: 'Web-optimized version of the dated Italian Release Evidence Pulse infographic.', it: 'Versione ottimizzata per il web dell infografica Release Evidence Pulse datata in italiano.' }, alt: { en: 'Six PolicyWatcher release cards in an Italian fourteen-day evidence infographic', it: 'Sei schede release PolicyWatcher in un infografica italiana sulle evidenze di quattordici giorni' }, usage: { en: 'Implementation inventory, not measured adoption, independent validation or compliance certification.', it: 'Inventario implementativo, non adozione misurata, validazione indipendente o certificazione di conformita.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-v4-foundation-beta-en-2026-08-20.png': { date: '2026-08-20', title: { en: 'PolicyWatcher 4 Foundation Beta infographic in English', it: 'Infografica PolicyWatcher 4 Foundation Beta in inglese' }, description: { en: 'Deterministically typeset release infographic covering the canonical evidence graph, stable public identifiers, provision taxonomy, database-derived readiness snapshot, controlled migration path, verification evidence and gated production boundaries. The decorative background is AI-generated and disclosed.', it: 'Infografica di release composta deterministicamente su grafo canonico delle evidenze, identificatori pubblici stabili, tassonomia delle provision, snapshot readiness derivato dal database, percorso di migrazione controllato, evidenze di verifica e limiti di produzione soggetti a gate. Lo sfondo decorativo e generato con AI e dichiarato.' }, alt: { en: 'PolicyWatcher 4 Foundation Beta infographic with the five-node evidence chain, six-topic taxonomy, five-stage readiness snapshot, migration controls and production boundaries', it: 'Infografica PolicyWatcher 4 Foundation Beta con catena delle evidenze a cinque nodi, tassonomia a sei temi, snapshot readiness a cinque stadi, controlli di migrazione e limiti di produzione' }, usage: { en: 'Dated aggregate operational snapshot, not a compliance result. GitHub promotion does not mean Hostinger deployment or infrastructure cutover.', it: 'Snapshot operativo aggregato e datato, non risultato di conformita. La promozione GitHub non equivale al deploy Hostinger o al cutover infrastrutturale.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-v4-foundation-beta-en-2026-08-20.webp': { date: '2026-08-20', title: { en: 'PolicyWatcher 4 Foundation Beta web infographic in English', it: 'Infografica web PolicyWatcher 4 Foundation Beta in inglese' }, description: { en: 'Web-optimized version of the dated English PolicyWatcher 4 Foundation Beta infographic.', it: 'Versione ottimizzata per il web dell infografica inglese PolicyWatcher 4 Foundation Beta datata.' }, alt: { en: 'PolicyWatcher 4 Foundation Beta web infographic with architecture, taxonomy, readiness and migration controls', it: 'Infografica web PolicyWatcher 4 Foundation Beta con architettura, tassonomia, readiness e controlli di migrazione' }, usage: { en: 'Dated aggregate operational snapshot, not a compliance result. GitHub promotion does not mean Hostinger deployment or infrastructure cutover.', it: 'Snapshot operativo aggregato e datato, non risultato di conformita. La promozione GitHub non equivale al deploy Hostinger o al cutover infrastrutturale.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-v4-beta2-value-infographic-en-2026-08-20.png': { date: '2026-08-20', title: { en: 'PolicyWatcher 4 operating-model guide in English', it: 'Guida inglese al modello operativo di PolicyWatcher 4' }, description: { en: 'A sober, deterministically typeset guide for product, governance, research and integration teams. It explains the move from PolicyWatcher 3.x change records to durable reusable evidence, then places architecture, Git and release state, integrations and workflow synergies in a separate technical mirror. The quiet illustration layer is AI-generated and disclosed.', it: 'Guida sobria e composta deterministicamente per team di prodotto, governance, ricerca e integrazione. Spiega il passaggio dai record di cambiamento di PolicyWatcher 3.x a evidenze durevoli e riutilizzabili, collocando architettura, stato Git e release, integrazioni e sinergie di workflow in uno specchio tecnico separato. Il livello illustrativo discreto e generato con AI e dichiarato.' }, alt: { en: 'PolicyWatcher 4 operating-model guide for product, governance, research and integration teams with a secondary technical reference', it: 'Guida al cambio di modello operativo di PolicyWatcher 4 per team di prodotto, governance, ricerca e integrazione, con uno specchio tecnico secondario' }, usage: { en: 'Dated release checkpoint, not continuous availability, compliance certification, corpus completeness or competitive superiority. Live readiness is not frozen into the asset.', it: 'Checkpoint di release datato, non disponibilita continua, certificazione di conformita, completezza del corpus o superiorita competitiva. La readiness live non e cristallizzata nell asset.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
  'policywatcher-v4-beta2-value-infographic-en-2026-08-20.webp': { date: '2026-08-20', title: { en: 'PolicyWatcher 4 operating-model web guide in English', it: 'Guida web inglese al modello operativo di PolicyWatcher 4' }, description: { en: 'Web-optimized version of the PolicyWatcher 4 operating-model guide.', it: 'Versione ottimizzata per il web della guida al modello operativo di PolicyWatcher 4.' }, alt: { en: 'PolicyWatcher 4 operating-model web guide with the 3.x comparison, practical meaning and secondary architecture, Git, integration and synergy reference', it: 'Guida web al modello operativo di PolicyWatcher 4 con confronto 3.x, significato pratico e riferimento secondario ad architettura, Git, integrazioni e sinergie' }, usage: { en: 'Dated release checkpoint, not continuous availability, compliance certification, corpus completeness or competitive superiority. Live readiness is not frozen into the asset.', it: 'Checkpoint di release datato, non disponibilita continua, certificazione di conformita, completezza del corpus o superiorita competitiva. La readiness live non e cristallizzata nell asset.' }, creator: 'PolicyWatcher / Fabrizio Degni', credit: CREDIT },
...
async function writeFactSheets() {
  const localized = {
    ...
    it: { title: 'Scheda stampa PolicyWatcher', lead: 'Dati configurati sul prodotto con perimetro e limiti di riuso espliciti.', releaseLabel: 'Release corrente', labels: ['aziende monitorate configurate', 'settori configurati', 'KPI canonici', 'lingue editoriali'], scopes: ['Esclude la fixture WAZE per l’onboarding amministrativo; non è copertura esaustiva.', 'Le etichette di settore organizzano l’inventario monitorato.', 'Privacy, governance AI ed etica; le valutazioni non disponibili sono Non valutato.', 'Press kit e alcune pagine guida selezionate.'], boundary: 'Non è consulenza legale, certificazione di conformità o copertura esaustiva del mercato.' },
  };
...
async function refreshLiveReleaseAssets() {
  ...
  const liveReleaseVisuals = [
    ['policywatcher-release-evidence-pulse-background-2026-08-15.png', 'image/png', 'IPTC Photo Metadata 2025.1'],
    ['policywatcher-release-evidence-pulse-en-2026-08-15.png', 'image/png', 'IPTC Photo Metadata 2025.1'],
    ['policywatcher-release-evidence-pulse-it-2026-08-15.png', 'image/png', 'IPTC Photo Metadata 2025.1'],
    ['policywatcher-release-evidence-pulse-en-2026-08-15.webp', 'image/webp', 'document-manifest'],
    ['policywatcher-release-evidence-pulse-it-2026-08-15.webp', 'image/webp', 'document-manifest'],
    ['policywatcher-v4-foundation-beta-en-2026-08-20.png', 'image/png', 'IPTC Photo Metadata 2025.1'],
    ['policywatcher-v4-foundation-beta-en-2026-08-20.webp', 'image/webp', 'document-manifest'],
    ['policywatcher-v4-beta2-value-infographic-en-2026-08-20.png', 'image/png', 'IPTC Photo Metadata 2025.1'],
    ['policywatcher-v4-beta2-value-infographic-en-2026-08-20.webp', 'image/webp', 'document-manifest'],
  ];
  for (const [filename] of liveReleaseVisuals) {
    if (!filename.endsWith('.png')) continue;
    injectPngXmp(path.join(PRESS_DIR, filename), buildXmp(mediaMetadata[filename]));
  }
  ...
  assetManifest.assets = [
    ...assetManifest.assets.filter((entry) => !/^policywatcher-fact-sheet-(en|it)-\d{4}-\d{2}-\d{2}\.(txt|pdf)$/.test(entry.filename) && !entry.filename.startsWith('policywatcher-release-evidence-pulse-') && !entry.filename.startsWith('policywatcher-v4-foundation-beta-') && !entry.filename.startsWith('policywatcher-v4-beta2-value-')),
    ...liveFactSheets.map(([filename, mediaType]) => manifestEntry(filename, mediaType)),
    ...liveReleaseVisuals.map(([filename, mediaType, metadataStandard]) => manifestEntry(filename, mediaType, metadataStandard)),
  ];
  ...
  process.stdout.write(`Refreshed live fact sheets, release evidence visuals and manifests for ${VERSION}; immutable campaign ZIPs were not rebuilt.\n`);
}
