...
required_sources=(
  package.json package-lock.json next.config.ts tsconfig.json server.js
...
required_entries=(
  ...
  src/app/associazioni/associazioni.module.css src/lib/associationVertical.ts
