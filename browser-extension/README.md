...
Manifest V3 browser extension for PolicyWatcher 3.8.0. Chrome and Microsoft Edge use this source directly. Safari uses the same web-extension source through Apple’s Safari Web Extension packager.
