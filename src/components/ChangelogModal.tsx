                ...
                <div className={styles.featureList}>
                  <div className={styles.featureItem}>
                    ...
                    <p className={styles.featureDesc}>
                      PolicyWatcher composes its native dashboard from validated contracts for modules, workspace state, actions, data sources, responsive layout and five governed visualizations. Versioned shareable evidence views encode public filter state in canonical URLs and restore committed context through browser history while stale values fail closed. The Evidence Newsroom adds English and Italian press packages, claim dates and status, a release archive, RSS and JSON Feed, reusable PNG, SVG, CSV and JSON snapshot formats, specialized contact routes and a public clarification register. Asset SHA-256 values establish file integrity, IPTC/XMP metadata records supplied editorial fields, and Content Credentials remain explicitly not attached. Normalized ordinal values remain screening aids rather than compliance or performance measurements. Vizro was studied as a pinned knowledge source; no Vizro, Dash, Flask or Python runtime was added.
                    </p>
                  </div>
