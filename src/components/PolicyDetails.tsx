        ...
        {activeTab === 'sources' && (
          <div className={styles.tabContent}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '16px', lineHeight: 1.5 }}>
              {lang === 'it'
                ? 'Tutti i documenti di policy attualmente configurati per questa azienda, con il link alla fonte e una ricerca di disponibilita su Wayback Machine.'
                : 'All policy sources currently configured for this company, with links to the configured source and a Wayback availability search.'}
            </p>
            ...
            <div className={styles.archiveList}>
              {(policy.siblingPolicies || []).map((sib) => {
                ...
                const waybackUrl = buildWaybackSearchUrl(sib.url);
                    ...
                    {isExpanded && (
                      <div className={styles.archiveTextContainer}>
                        <div className={styles.archiveActions}>
                          ...
                          <a
                            href={buildWaybackSnapshotSearchUrl(policy.url, new Date(snapshot.createdAt))}
                            target="_blank"
                            rel="noreferrer"
