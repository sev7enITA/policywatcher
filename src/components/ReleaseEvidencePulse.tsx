...
const COPY = {
  en: {
    ...
    release: 'Window-closing Beta 42 record',
    infographic: 'Release infographic',
    archive: 'Release archive',
    select: 'Open release receipt',
    current: 'Window-closing release receipt',
    version: 'Version',
    date: 'Date',
    wave: 'Wave',
  ...
  it: {
    ...
    release: 'Record Beta 42 di chiusura finestra',
    infographic: 'Infografica release',
    archive: 'Archivio release',
    select: 'Apri ricevuta di release',
    current: 'Ricevuta di chiusura della finestra',
    version: 'Versione',
    date: 'Data',
    wave: 'Ondata',
