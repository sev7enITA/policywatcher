...
import { ArrowRight, BookOpenCheck, FileSearch } from 'lucide-react';
...
export default function HomeKnowledgeSnapshot({ data }: HomeKnowledgeSnapshotProps) {
  return (
    <section className={styles.section} aria-labelledby="public-knowledge-title">
      <div className={styles.header}>
        <div>
          <span className={styles.kicker}><BookOpenCheck size={14} aria-hidden="true" /> Crawlable public knowledge</span>
          <h2 id="public-knowledge-title">Verified records, available as linked text.</h2>
