...
const copy = {
  en: {
    ...
    releaseDate: 'Released 1 August 2026',
    ...
    releaseFreshnessBody: 'Current to 1 August 2026 for the web application.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 1 August 2026, https://policywatcher.online/press-kit (accessed [date]).`,
  ...
  it: {
    ...
    releaseDate: 'Rilasciata il 1 agosto 2026',
    ...
    releaseFreshnessBody: 'Correnti al 1 agosto 2026 per l applicazione web.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 1 agosto 2026, https://policywatcher.online/press-kit (consultato il [data]).`,
