...
const copy = {
  en: {
    ...
    releaseDate: 'Released 31 July 2026',
    ...
    releaseFreshnessBody: 'Current to 31 July 2026 for the web application.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 31 July 2026, https://policywatcher.online/press-kit (accessed [date]).`,
  ...
  it: {
    ...
    releaseDate: 'Rilasciata il 31 luglio 2026',
    ...
    releaseFreshnessBody: 'Correnti al 31 luglio 2026 per l applicazione web.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 31 luglio 2026, https://policywatcher.online/press-kit (consultato il [data]).`,
