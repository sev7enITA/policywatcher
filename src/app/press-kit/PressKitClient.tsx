...
const copy = {
  en: {
    ...
    releaseDate: 'Released 29 July 2026',
    ...
    releaseFreshnessBody: 'Current to 29 July 2026 for the web application.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 29 July 2026, https://policywatcher.online/press-kit (accessed [date]).`,
  ...
  it: {
    ...
    releaseDate: 'Rilasciata il 29 luglio 2026',
    ...
    releaseFreshnessBody: 'Correnti al 29 luglio 2026 per l applicazione web.',
    ...
    citationText: `PolicyWatcher, ${POLICYWATCHER_VERSION_DISPLAY} ${POLICYWATCHER_RELEASE_NAME}, 29 luglio 2026, https://policywatcher.online/press-kit (consultato il [data]).`,
