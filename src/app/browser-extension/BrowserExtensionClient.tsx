...
const copy = {
  it: {
    ...
    install: 'Installa dallo store', pending: 'Pubblicazione nello store in corso', safariNote: 'La sorgente Safari non equivale a un’app installabile. La disponibilità mobile verrà dichiarata solo dopo firma e revisione App Store.',
  ...
  en: {
    ...
    install: 'Install from store', pending: 'Store publication in progress', safariNote: 'Safari source is not an installable app. Mobile availability will be stated only after App Store signing and review.',
