...
const copy = {
  it: {
    ...
    extensionChoiceLabel: 'Computer · Beta', extensionChoiceTitle: 'Usa l’estensione browser', extensionChoiceBody: 'Legge localmente il testo e i link presenti nella pagina. In questa Beta, estrazione o evidenze possono essere incomplete.', extensionChoiceAction: 'Dettagli estensione Beta',
    pasteChoiceLabel: 'Telefono o computer', pasteChoiceTitle: 'Incolla il testo visibile', pasteChoiceBody: 'Il testo semplice non include i link nascosti. PolicyWatcher usa le fonti configurate o registra una richiesta limitata di discovery e QA.', pasteChoiceAction: 'Vai al copia-incolla',
    ...
    scopeTitle: '3. Dalla policy segnalata al portafoglio configurato', scopeBody: 'Le categorie selezionate danno priorità all’analisi. PolicyWatcher controlla il portafoglio di policy pubbliche configurato per l’azienda.',
    ...
    workflowEyebrow: 'Flusso di elaborazione', workflowTitle: 'Dalla mail al risultato pubblico, in quattro passaggi',
    ...
    humanGate: 'Revisione umana prima della pubblicazione', humanSteps: ['Approva l’azienda', 'Rivedi le fonti ufficiali', 'Crea la prima baseline', 'Avvia il monitoraggio ricorrente', 'Applica il gate QA prima della pubblicazione'],
  ...
  en: {
    ...
    extensionChoiceLabel: 'Computer · Beta', extensionChoiceTitle: 'Use the browser extension', extensionChoiceBody: 'It reads text and links present on the page locally. In this Beta, extraction or evidence may be incomplete.', extensionChoiceAction: 'Beta extension details',
    pasteChoiceLabel: 'Phone or computer', pasteChoiceTitle: 'Paste visible text', pasteChoiceBody: 'Plain text does not include hidden links. PolicyWatcher uses configured sources or registers a limited discovery and QA request.', pasteChoiceAction: 'Go to paste',
    ...
    scopeTitle: '3. From the reported policy to the configured portfolio', scopeBody: 'Selected categories prioritize the analysis. PolicyWatcher checks the configured public policy portfolio for the company.',
    ...
    workflowEyebrow: 'Processing flow', workflowTitle: 'From an email to a public result, in four steps',
    ...
    humanGate: 'Human review before publication', humanSteps: ['Approve the company', 'Review official sources', 'Create the first baseline', 'Start recurring monitoring', 'Apply the QA gate before publication'],
