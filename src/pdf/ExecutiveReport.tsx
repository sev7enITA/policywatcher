 ...
 * High (7 or above) maps to red, Medium (4 or above) maps to amber, Low maps to green.
 */
...
export default function ExecutiveReport({
  ...
  const L = {
    ...
    low: isIt ? 'Basso' : 'Low',
    disclaimer:
      'CONFIDENCE RELEASE v3.5: AI-assisted assessment of publicly available policy texts. Not legal advice. ' +
      'Not a compliance certification. Always consult provider sources and qualified legal counsel. ' +
