...
export const publicSectionNodes: PublicSectionNode[] = [
  ...
  },
  {
    ...
    href: '/press-kit',
    group: 'community',
    summary: 'Bilingual newsroom with publication-ready facts, claim evidence, owned assets and citation guidance.',
    role: 'Use it to verify product claims and download press materials; external coverage remains on the Press Wall.',
    status: 'reference',
    icon: 'file-text',
    x: 54,
    y: 25,
