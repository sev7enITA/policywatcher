...
export const publicSectionNodes: PublicSectionNode[] = [
  ...
  {
    id: 'feature-atlas',
    label: 'Feature Intelligence Atlas',
    href: '/feature-atlas',
    group: 'core',
    summary: 'Capability-level operational constellation connecting outcomes, dependencies, implementation proof and residual limits.',
    role: 'Use it to inspect release-linked capabilities and qualitative KPI/KRI impact; the Site Atlas remains the page map.',
    status: 'reference',
    icon: 'sparkles',
    x: 65,
    y: 45,
  },
  {
    ...
    role: 'Use it to review the limits that govern dashboard interpretation.',
    status: 'reference',
    icon: 'file-text',
    x: 89,
    y: 59,
...
export const publicSectionEdges: PublicSectionEdge[] = [
  ...
  { from: 'feature-atlas', to: 'dashboard', label: 'maps capabilities behind', strength: 'primary' },
  { from: 'feature-atlas', to: 'roadmap', label: 'traces delivery horizons from', strength: 'primary' },
  { from: 'feature-atlas', to: 'methodology', label: 'qualifies feature claims with', strength: 'secondary' },
  { from: 'terms', to: 'methodology', label: 'states use boundaries alongside', strength: 'primary' },
