export const POLICYWATCHER_VERSION = '3.9.0-beta.18' as const;
export const POLICYWATCHER_VERSION_DISPLAY = '3.9.0 Beta 18' as const;
export const POLICYWATCHER_RELEASE_NAME = 'Evidence Workflow Refinements' as const;
