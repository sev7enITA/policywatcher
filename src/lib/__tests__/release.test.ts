...
describe('release metadata', () => {
  it('matches the package version and composes one build label', () => {
    ...
    expect(POLICYWATCHER_BUILD_LABEL).toBe('v3.9.0-beta.30 Enterprise Agent & Contract Evidence Integration');
    ...
    expect(POLICYWATCHER_RELEASE_BADGE).toBe('v3.9.0-beta.30 · BETA');
