...
describe('release metadata', () => {
  it('matches the package version and composes one build label', () => {
    ...
    expect(POLICYWATCHER_BUILD_LABEL).toBe('v3.9.0-beta.37 Resource Navigation & Retrieval Diagnostics');
    ...
    expect(POLICYWATCHER_RELEASE_BADGE).toBe('v3.9.0-beta.37 · BETA');
