...
| --- | --- | --- | --- | --- |
| Web application | `4.0.0-beta.3` candidate | unversioned public routes plus `/api/v1` and protected `/api/v2` | Current candidate | Deployment must be verified separately. |
